...
namespace MeControla.AgileManager.DataStorage.Migrations
{
    ...
    [Migration("20221111145625_Migration004")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeControla.AgileManager.Data.Entities.PreferenceClasseOfService", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<long>("ClasseOfServiceId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ClasseOfServiceId");

                    b.HasIndex("ProjectId");

                    b.ToTable("PreferenceClasseOfServices");
                });
            ...
            modelBuilder.Entity("MeControla.AgileManager.Data.Entities.PreferenceClasseOfService", b =>
                {
                    b.HasOne("MeControla.AgileManager.Data.Entities.ClasseOfService", "ClasseOfService")
                        .WithMany()
                        .HasForeignKey("ClasseOfServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
