...
namespace MeControla.AgileManager.DataStorage.Migrations
{
    ...
    [Migration("20221121190137_Migration009")]
            ...
            modelBuilder.Entity("MeControla.AgileManager.Data.Entities.PreferenceStatusCategory", b =>
                {
                    ...
                    b.Property<long?>("StatusCategoryId1")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MeControla.AgileManager.Data.Entities.PreferenceCustomField", b =>
                {
                    ...
                    b.HasOne("MeControla.AgileManager.Data.Entities.CustomField", null)
                        .WithOne("Preference")
                        .HasForeignKey("MeControla.AgileManager.Data.Entities.PreferenceCustomField", "CustomFieldId1");
            ...
            modelBuilder.Entity("MeControla.AgileManager.Data.Entities.PreferenceIssueType", b =>
                {
                    ...
                    b.HasOne("MeControla.AgileManager.Data.Entities.IssueType", null)
                        .WithOne("Preference")
                        .HasForeignKey("MeControla.AgileManager.Data.Entities.PreferenceIssueType", "IssueTypeId1");
            ...
            modelBuilder.Entity("MeControla.AgileManager.Data.Entities.PreferenceStatusCategory", b =>
                {
                    ...
                    b.HasOne("MeControla.AgileManager.Data.Entities.StatusCategory", null)
                        .WithOne("Preference")
                        .HasForeignKey("MeControla.AgileManager.Data.Entities.PreferenceStatusCategory", "StatusCategoryId1");
