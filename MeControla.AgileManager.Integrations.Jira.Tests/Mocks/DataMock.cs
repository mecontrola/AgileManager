...
namespace MeControla.AgileManager.Integrations.Jira.Tests.Mocks
{
    public class DataMock
    {
        ...
        public static int INT_ID_8 { get; } = 8;
        public static int INT_ID_9 { get; } = 9;
        ...
        public static string FIELD_ID_CLASSES_OF_SERVICE { get; } = "customfield_10054";
        public static string FIELD_NAME_CLASSES_OF_SERVICE { get; } = "Classes of Service";

        public static string CONTEXT_ID_DEFAULT { get; } = "10181";
        public static string CONTEXT_NAME_DEFAULT { get; } = "Default Configuration Scheme for Classes of Service";

        public static string CLASSES_OF_SERVICE_EXPEDITE { get; } = "Expedite";
    }
}