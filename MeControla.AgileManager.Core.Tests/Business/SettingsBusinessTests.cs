...
namespace MeControla.AgileManager.Core.Tests.Business
{
    public class SettingsBusinessTests : BaseAsyncMethods
    {
        ...
        {
            var actual = await settingsBusiness.SaveAuthenticationAsync(DataMock.JIRA_HOST, DataMock.VALUE_USERNAME, DataMock.VALUE_PASSWORD, GetCancellationToken());
        ...
        {
            var actual = await settingsBusiness.SavePreferencesAsync(DataMock.BOOL_TRUE, DataMock.BOOL_TRUE, DataMock.VALUE_DEFAULT_9, GetCancellationToken());
